#!/bin/bash
# taotao-cloud-auth 安全扫描脚本
# 用于检查 DDD 项目中的常见安全问题

echo "================================================"
echo "  taotao-cloud-auth 安全扫描"
echo "================================================"

# 扫描配置
BASE_DIR="."
MODULES=("taotao-cloud-auth-api" "taotao-cloud-auth-application" "taotao-cloud-auth-domain" "taotao-cloud-auth-infrastructure" "taotao-cloud-auth-interfaces")
HAS_WARNINGS=0
