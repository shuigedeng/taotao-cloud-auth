...
import com.taotao.cloud.auth.infrastructure.persistent.shared.jackson2.SetToCommaDelimitedStringDeserializer;
 ...
 */
@MappedSuperclass
public abstract class AbstractRegisteredClient<T extends AbstractRegisteredClient<T, I>, I extends Serializable> extends
	BaseSuperEntity<T, I> implements
