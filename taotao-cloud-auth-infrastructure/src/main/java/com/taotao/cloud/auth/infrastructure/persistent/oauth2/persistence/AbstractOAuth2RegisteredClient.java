 ...
 */
@MappedSuperclass
public abstract class AbstractOAuth2RegisteredClient<T extends AbstractOAuth2RegisteredClient<T, I>, I extends Serializable>
	extends AbstractRegisteredClient<T, I> {
