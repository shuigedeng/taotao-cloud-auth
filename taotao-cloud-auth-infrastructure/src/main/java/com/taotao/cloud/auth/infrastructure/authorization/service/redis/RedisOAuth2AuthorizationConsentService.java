...
public final class RedisOAuth2AuthorizationConsentService extends
	...
	public void remove(OAuth2AuthorizationConsent authorizationConsent) {
		if (authorizationConsent != null) {
			...
			redisRepository.del(
				principalName + OAUTH2_AUTHORIZATION_CONSENT + registeredClientId + ":"
					+ principalName);
	...
	public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
		...
		OAuth2AuthorizationConsent oauth2AuthorizationConsentRedis = (OAuth2AuthorizationConsent) redisRepository
			.opsForValue()
			.get(PREFIX + OAUTH2_AUTHORIZATION_CONSENT + registeredClientId + ":" + principalName);
	...
	public void set(OAuth2AuthorizationConsent authorizationConsent, long timeout, TimeUnit unit) {
		...
		redisRepository
			.opsForValue()
			.set(PREFIX + OAUTH2_AUTHORIZATION_CONSENT + registeredClientId + ":" + principalName,
