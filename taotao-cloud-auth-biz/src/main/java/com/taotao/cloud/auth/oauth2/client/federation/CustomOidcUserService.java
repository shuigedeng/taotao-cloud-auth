...
package com.taotao.cloud.auth.oauth2.client.federation;

import com.taotao.cloud.auth.oauth2.client.federation.strategy.context.Oauth2UserConverterContext;
