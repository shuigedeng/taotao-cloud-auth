...
public class OAuth2ScopePermissionRelation extends BasePO<OAuth2ScopePermissionRelation> {
	public static final String TABLE_NAME = "ttc_oauth2_scope_permission";
