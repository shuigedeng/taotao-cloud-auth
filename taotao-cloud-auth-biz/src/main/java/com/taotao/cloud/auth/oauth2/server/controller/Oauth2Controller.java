...
package com.taotao.cloud.auth.oauth2.server.controller;
...
import com.taotao.cloud.auth.oauth2.client.federation.Oauth2UserinfoResult;
...
import static com.taotao.boot.common.constant.RedisConstants.LOGOUT_JWT_KEY_PREFIX;
        ...
        if (authentication instanceof JwtAuthenticationToken jwtAuthenticationToken) {
            ...
            try {
                ...
                redisRepository.setEx(
                        LOGOUT_JWT_KEY_PREFIX + kid, "", epochSecond - nowTime);
