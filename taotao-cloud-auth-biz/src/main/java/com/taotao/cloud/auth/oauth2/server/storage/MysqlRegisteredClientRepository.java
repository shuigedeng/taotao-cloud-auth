...
import com.taotao.cloud.auth.oauth2.server.converter.OAuth2ToTtcRegisteredClientConverter;
import com.taotao.cloud.auth.oauth2.server.converter.TtcToOAuth2RegisteredClientConverter;
 ...
 */
public class MysqlRegisteredClientRepository implements RegisteredClientRepository {

    /**
     * 日志
     */
    private static final Logger log = LoggerFactory.getLogger(MysqlRegisteredClientRepository.class);
     ...
     * @since 2023-07-10 17:10:47
     */
    public MysqlRegisteredClientRepository(
