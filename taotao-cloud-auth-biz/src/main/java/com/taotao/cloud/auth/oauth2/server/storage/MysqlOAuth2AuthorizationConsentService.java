...
package com.taotao.cloud.auth.oauth2.server.storage;

import com.taotao.cloud.auth.oauth2.server.converter.OAuth2ToTtcAuthorizationConsentConverter;
import com.taotao.cloud.auth.oauth2.server.converter.TtcToOAuth2AuthorizationConsentConverter;
 ...
 */
public class MysqlOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {

    /**
     * 日志
     */
    private static final Logger log =
            LoggerFactory.getLogger(MysqlOAuth2AuthorizationConsentService.class);
     ...
     */
    public MysqlOAuth2AuthorizationConsentService(
