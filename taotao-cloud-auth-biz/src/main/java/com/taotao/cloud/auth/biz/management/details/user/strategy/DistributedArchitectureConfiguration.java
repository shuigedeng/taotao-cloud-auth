...
package com.taotao.cloud.auth.biz.management.details.user.strategy;

import com.taotao.cloud.auth.biz.management.details.user.strategy.local.LocalPermissionDetailsService;
import com.taotao.cloud.auth.biz.management.details.user.strategy.local.SysPermissionService;
import com.taotao.cloud.auth.biz.management.details.user.strategy.remote.RemotePermissionDetailsService;
import com.taotao.cloud.auth.biz.management.details.user.strategy.remote.RemoteUserDetailsService;
