...
package com.taotao.cloud.auth.oauth2.client.federation.strategy.context;

import com.taotao.cloud.auth.oauth2.client.federation.Oauth2ThirdAccount;
import com.taotao.cloud.auth.oauth2.client.federation.strategy.Oauth2UserConverterStrategy;
...
public class Oauth2UserConverterContext {
    ...
    public Oauth2ThirdAccount convert(OAuth2UserRequest userRequest, OAuth2User oAuth2User) {
        ...
        Oauth2ThirdAccount oauth2ThirdAccount =
                this.getInstance(registrationId).convert(oAuth2User);
        // 获取AccessToken
