...
package com.taotao.cloud.auth.biz.management.details.user;
...
import com.taotao.boot.security.spring.support.core.details.user.EnhanceUserDetailsService;
    ...
    public UserDetails loadUserBySocial(String source, AccessPrincipal accessPrincipal)
        ...
        TtcUser TtcUser =
                strategyUserDetailsService.findUserDetailsBySocial(
                        toRootUpperCase(source), accessPrincipal);
