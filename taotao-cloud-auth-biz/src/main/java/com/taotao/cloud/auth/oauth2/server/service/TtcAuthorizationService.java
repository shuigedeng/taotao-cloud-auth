...
public class TtcAuthorizationService {
    ...
    public Optional<TtcAuthorization> findByOidcIdTokenValue(String idToken) {
        Optional<TtcAuthorization> result =
                this.ttcAuthorizationRepository.findByOidcIdTokenValue(idToken);
    ...
    public Optional<TtcAuthorization> findByUserCodeValue(String userCode) {
        Optional<TtcAuthorization> result =
                this.ttcAuthorizationRepository.findByUserCodeValue(userCode);
    ...
    public Optional<TtcAuthorization>
        ...
        Specification<TtcAuthorization> specification =
                (root, criteriaQuery, criteriaBuilder) -> {
                    List<Predicate> predicates = new ArrayList<>();
                    predicates.add(criteriaBuilder.equal(root.get("state"), token));
                    predicates.add(
                            criteriaBuilder.equal(root.get("authorizationCodeValue"), token));
     ...
     * @since 2023-07-10 17:10:06
     */
    public List<TtcAuthorization> findAvailableAuthorizations(
            String registeredClientId, String principalName) {
        List<TtcAuthorization> authorizations =
                this.ttcAuthorizationRepository
