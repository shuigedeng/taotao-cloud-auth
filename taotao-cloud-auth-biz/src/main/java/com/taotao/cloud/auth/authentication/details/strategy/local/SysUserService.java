...
import com.taotao.cloud.auth.authentication.details.strategy.user.SysUser;
...
//    public SysUser register(SysUser sysUser, AccountTypeEnum source) {
...
//
//        return register(sysUser, AccountTypeEnum.getAccountType(socialUserDetails.getSource()));
//    }
//
