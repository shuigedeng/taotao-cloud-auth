...
import com.taotao.cloud.auth.infrastructure.authentication.device.DeviceClientAuthenticationConverter;
import com.taotao.cloud.auth.infrastructure.authentication.device.DeviceClientAuthenticationProvider;
import com.taotao.cloud.auth.infrastructure.authentication.extension.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.taotao.cloud.auth.infrastructure.authentication.extension.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.taotao.cloud.auth.infrastructure.authentication.extension.social.OAuth2SocialCredentialsAuthenticationConverter;
import com.taotao.cloud.auth.infrastructure.authentication.extension.social.OAuth2SocialCredentialsAuthenticationProvider;
import com.taotao.cloud.auth.infrastructure.authentication.oidc.TtcOidcUserInfoMapper;
import com.taotao.cloud.auth.infrastructure.authentication.response.OAuth2AccessTokenResponseHandler;
